      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <ScrollAnimation delay={200}>
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-muted-foreground">Skin Treatments</li>
              <li className="text-muted-foreground">Laser Hair Removal</li>
              <li className="text-muted-foreground">Teeth Whitening</li>
              <li className="text-muted-foreground">Chemical Peels</li>
              <li className="text-muted-foreground">Microneedling</li>
            </ul>
          </div>
        </ScrollAnimation>
